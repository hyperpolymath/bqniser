...
==== Added
- Bespoke Idris2 ABI types: ArrayRank, BQNPrimitive, Train, Modifier, UnderCombinator
- Zig FFI bridge stubs for CBQN C API integration
- CLI scaffold with subcommands (init, validate, generate, build, run, info)
- Manifest parser for bqniser.toml
- Codegen engine stubs for BQN expression generation (trains, under, modifiers)
