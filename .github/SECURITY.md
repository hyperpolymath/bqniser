...
Replace all {{PLACEHOLDER}} values with your information:
  bqniser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  bqniser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/bqniser/security/advisories/new)
...
- This repository (`hyperpolymath/bqniser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/bqniser/security/advisories)
...
When using bqniser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/bqniser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/bqniser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/bqniser/discussions) |
...
*Thank you for helping keep bqniser and its users safe.* 🛡️
